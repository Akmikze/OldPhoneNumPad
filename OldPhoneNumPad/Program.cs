...
public static class Program
{
    ...
    private const string InvalidInputMessage = "Remember to enter Valid Data / Recuerda usar datos validos";
    ...
    private static void RunTestCase(string input, string expectedOutput) // Test case runner / Ejecutar caso de prueba
    {
        try // Try to run the test case / Intentar ejecutar el caso de prueba
        {
            ...
            {
                Console.WriteLine($"Input: {input} is invalid. | {expectedOutput}"); // We show the invalid input message / Mostramos el mensaje de entrada invalida
            }
        }
    ...
    private static void TestCases() // Test cases / Casos de prueba
    {
        ...
        RunTestCase("7**#", "ERROR: YOU CAN'T USE TWO ASTERISK ONE AFTER THE OTHER");
        ...
        RunTestCase("A#", "ERROR: ONLY NUMBERS ARE ALLOWED ON THE INPUT");
